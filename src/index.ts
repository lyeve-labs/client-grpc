 ...
 *   import { listSchemas, getSchema, listContent } from '@lyeve/cms-client-grpc';
 *
...
import type { Schema, Content } from '@lyeve/cms-client';
...
export function createContent(
	...
	return client.post<Content>(`/api/content/${encodeURIComponent(schemaName)}`, { data });
}
