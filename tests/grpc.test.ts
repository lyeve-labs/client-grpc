...
describe("SchemaService (gRPC gateway)", () => {
  ...
  describe("listSchemas()", () => {
    it("GETs /api/schemas and returns the schema list", async () => {
      const schemas = [
        { name: "article", display_name: "Article", fields: [] },
      ];
...
describe("ContentService (gRPC gateway)", () => {
  ...
  describe("getContent()", () => {
    ...
    it("propagates a 404 error", async () => {
      ...
      const err = await getContent("article", "missing", client).catch(
        (e: unknown) => e,
      );
  ...
  describe("createContent()", () => {
    ...
    it("propagates validation errors", async () => {
      ...
      const err = await createContent("article", {}, client).catch(
        (e: unknown) => e,
      );
  ...
  describe("updateContent()", () => {
    ...
    it("propagates a 404 error", async () => {
      ...
      const err = await updateContent("article", "missing", {}, client).catch(
        (e: unknown) => e,
      );
  ...
  describe("deleteContent()", () => {
    ...
    it("propagates API errors", async () => {
      ...
      const err = await deleteContent("article", "missing", client).catch(
        (e: unknown) => e,
      );
